...
export interface ApiBarraDeNavegacionBarraDeNavegacion
  extends Struct.SingleTypeSchema {
  collectionName: 'barra_de_navegacions';
  info: {
    displayName: 'barra de navegacion';
    pluralName: 'barra-de-navegacions';
    singularName: 'barra-de-navegacion';
  };
  options: {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::barra-de-navegacion.barra-de-navegacion'
    > &
      Schema.Attribute.Private;
...
export interface ApiHomeHome extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::home.home'> &
      Schema.Attribute.Private;
    productos: Schema.Attribute.Component<'navegacion.boton', false>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    categorie: Schema.Attribute.Component<'categories.categorie', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    variants: Schema.Attribute.Component<'photos.photo', true> &
      Schema.Attribute.Required;
  };
}
...
export interface PluginShopifyShop extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    adminApiAccessToken: Schema.Attribute.String & Schema.Attribute.Required;
    apiKey: Schema.Attribute.String & Schema.Attribute.Required;
    apiSecretKey: Schema.Attribute.String & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    isActive: Schema.Attribute.Boolean &
    ...
    webhooks: Schema.Attribute.Relation<'oneToMany', 'plugin::shopify.webhook'>;
  };
}

export interface PluginShopifyWebhook extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    callbackUrl: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    errors: Schema.Attribute.JSON;
    format: Schema.Attribute.Enumeration<['JSON']>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'plugin::shopify.webhook'
    > &
      Schema.Attribute.Private;
    method: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    service: Schema.Attribute.String & Schema.Attribute.Required;
    shop: Schema.Attribute.Relation<'manyToOne', 'plugin::shopify.shop'>;
    shopifyId: Schema.Attribute.String;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'plugin::shopify.shop': PluginShopifyShop;
      'plugin::shopify.webhook': PluginShopifyWebhook;
